...
public final class SystemConstants {
	...
	public final static String BEHAVIOR_SELECT="select";
	...
	public final static String BEHAVIOR_BLUR="blur";
	
	public final static String BEHAVIOR_HOVER="hover";
	
	public final static String BEHAVIOR_CLEAR="clear";
	...
	public final static String BEHAVIOR_STYLE="[css]";
