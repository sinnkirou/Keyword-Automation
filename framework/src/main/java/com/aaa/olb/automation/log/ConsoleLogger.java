...
public class ConsoleLogger implements ActionLogger {
	...
	public void error(Object sender, BaseAction action, String message) {
		...
		System.out
				.println(String.format("%s%s| %s", LoggerHelper.formatConsoleLog("ERROR"), action.toString(), message));
		Log.error(msg);
	}
	...
	public void error(Object sender, BaseAction action, String message, Exception ex) {
		...
		System.out.println(String.format("%s%s| %s | %s", LoggerHelper.formatConsoleLog("ERROR"), action.toString(),
